...
export default function NeonBanner() {
  return (
    <section className="relative flex flex-col items-center justify-center py-20 md:py-32 select-none animate-shimmer">
      ...
      <motion.h1
        className="neon-text text-4xl md:text-7xl font-extrabold text-center drop-shadow-lg flicker z-10"
      ...
      <motion.p
        className="text-xl md:text-3xl text-neon-blue mt-6 mb-10 text-center z-10"
      ...
      <motion.button
        className="neon-btn px-10 py-4 text-2xl font-bold uppercase shadow-lg z-10 group"
      ...
      >
        Играть сейчас
        <span className="ml-2 text-neon-green text-lg animate-pulse group-hover:scale-125 transition-transform">↓</span>
      </motion.button>
      <div className="absolute left-0 bottom-0 w-full h-2 bg-gradient-to-r from-neon-pink via-neon-blue to-neon-green opacity-30 blur-lg animate-pulse" />
    </section>
  )
}
